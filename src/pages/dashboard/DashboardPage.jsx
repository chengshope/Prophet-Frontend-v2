...
import { Typography, Row, Col, Card, Statistic, Progress, List, Avatar } from 'antd';
  ...
  return (
    <div>
      ...
      <Row gutter={[16, 16]}>
        ...
        {/* Recent Activities */}
        <Col xs={24} lg={8}>
          <Card title='Recent Activities' extra={<a href='#'>View All</a>} style={{ height: '100%' }}>
            <List
          ...
          <Card title='Quick Actions'>
            <Row gutter={[16, 16]}>
              <Col xs={24} sm={12} md={6}>
                <Card hoverable style={{ textAlign: 'center' }} bodyStyle={{ padding: '24px 16px' }}>
              ...
              <Col xs={24} sm={12} md={6}>
                <Card hoverable style={{ textAlign: 'center' }} bodyStyle={{ padding: '24px 16px' }}>
                  <RiseOutlined style={{ fontSize: '32px', color: '#722ed1', marginBottom: '8px' }} />
                  <div>Analytics</div>
                </Card>
              </Col>
            </Row>
