import { Card, Col, DatePicker, Empty, Row, Select, Space, Statistic, Table, Tabs, Typography } from 'antd';
    ...
    <Row gutter={[16, 16]} align="middle">
      <Col xs={24} sm={12} md={8} lg={6}>
        <Space direction="vertical" size="small">
          ...
          <RangePicker value={dateRange} onChange={onDateRangeChange} allowClear={false} picker={picker} />
        </Space>
      </Col>
      <Col xs={24} sm={12} md={8} lg={6}>
        <Space direction="vertical" size="small">
...
const ExecutiveSummaryTab = () => {
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      <Filters dateRange={range} onDateRangeChange={setRange} facility={facility} onFacilityChange={setFacility} />
      <Row gutter={[16, 16]}>
        {[
...
const ExistingRatesTab = () => {
  ...
  return (
    <Space direction="vertical" size="large" style={{ width: '100%' }}>
      <Filters dateRange={range} onDateRangeChange={setRange} facility={facility} onFacilityChange={setFacility} picker="month" />
      <Card>
        <Table columns={columns} dataSource={data} pagination={false} size="middle" />
      </Card>
    </Space>
...
const tabItems = [
  { key: 'executive-summary', label: 'Executive Summary', children: <ExecutiveSummaryTab />, path: '/reporting/executive-summary' },
  { key: 'street-rates', label: 'Street Rates', children: <StreetRatesTab />, path: '/reporting/street-rates' },
  { key: 'existing-rates', label: 'Existing Rates', children: <ExistingRatesTab />, path: '/reporting/existing-rates' },
];
...
const ReportingPage = () => {
  ...
  useEffect(() => {
    ...
    const currentKey = tabItems.find((t) => currentPath.startsWith(t.path))?.key || 'executive-summary';
