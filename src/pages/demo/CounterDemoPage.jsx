...
const CounterDemoPage = () => {
  ...
  return (
    <div>
      ...
      <Text type="secondary">
        This page demonstrates Redux Toolkit state management with a simple counter.
      </Text>
          ...
          <Card title="Counter Statistics">
            ...
            <div>
              ...
              <ul style={{ marginTop: '8px', paddingLeft: '20px' }}>
                <li><Text type="secondary">Immutable state updates</Text></li>
                <li><Text type="secondary">Action creators</Text></li>
                <li><Text type="secondary">useSelector for reading state</Text></li>
                <li><Text type="secondary">useDispatch for dispatching actions</Text></li>
              </ul>
            </div>
          </Card>
        </Col>
